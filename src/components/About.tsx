    ...
    <div className="night-sky-bg">
      <section className="py-12 sm:py-20 bg-transparent">
        <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="bg-slate-700/50 rounded-2xl p-5 sm:p-8 border border-slate-600">
            <div className="mb-8">
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6 flex items-center">
                <span className="mr-3 text-2xl sm:text-[28px] leading-none" aria-hidden>👋</span>
                Hi! I'm W. V. P. S. SRIRAJ
              </h3>
              <p className="text-gray-300 text-base sm:text-lg leading-[1.7] sm:leading-relaxed mb-4 sm:mb-6 text-center">
              ...
              <p className="text-gray-300 text-base sm:text-lg leading-[1.7] sm:leading-relaxed mb-6 sm:mb-8 text-center">
              ...
              <div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  {technicalSkills.map((skill, index) => (
                    <div key={index} className="flex items-center gap-3 text-gray-300 text-sm sm:text-base leading-[1.6]">
