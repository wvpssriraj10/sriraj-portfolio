            ...
            <div className="max-w-lg">
              <form onSubmit={handleSubmit} className="space-y-6">
                <input
                  ...
                  autoComplete="off"
                />
                {/* Optional additional honeypot field recognized by FormSubmit */}
              ...
              <div className="relative mb-8 flex flex-col items-center">
                ...
                <div className="w-[28rem] h-[28rem] rounded-full bg-gradient-to-r from-cyan-400/20 to-blue-500/20 animate-pulse flex items-center justify-center">
                  ...
                  <div className="w-[24rem] h-[24rem] rounded-full bg-gradient-to-r from-cyan-500/30 to-blue-600/30 flex items-center justify-center">
                    ...
                    <div className="w-[20rem] h-[20rem] rounded-full overflow-hidden border-4 border-cyan-400/70">
                      <img 
                        src="/sriraj1.jpg"
                        alt="W V P S SRIRAJ"
                        className="w-full h-full object-cover" // No shadow or glow here!
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-14 -left-14 w-6 h-6 bg-blue-400 rounded-full animate-bounce delay-300"></div>
